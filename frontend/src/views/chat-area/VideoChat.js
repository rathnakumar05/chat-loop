        ...
        <div className="modal fade" ref={modal_ref} tabIndex="-1" aria-hidden="true">
          <div className="modal-dialog modal-xl modal-dialog-centered">
            <div className="modal-content">
              ...
              <video ref={local} className="w-100 h-75" style={{height: "400px"}} autoPlay playsInline ></video>
              <video ref={remote} className="position-absolute bottom-0 end-0" style={{ width: "300px", height: "300px"}} autoPlay playsInline ></video>
              </div>
